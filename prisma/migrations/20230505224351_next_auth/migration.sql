...
-- DropForeignKey
ALTER TABLE "_ExpenseSplittingWindowToUser" DROP CONSTRAINT "_ExpenseSplittingWindowToUser_B_fkey";

-- DropForeignKey
ALTER TABLE "_authorizedUsers" DROP CONSTRAINT "_authorizedUsers_A_fkey";

-- DropForeignKey
ALTER TABLE "_authorizedUsers" DROP CONSTRAINT "_authorizedUsers_B_fkey";
...
-- AlterTable
ALTER TABLE "UserPreferences" ALTER COLUMN "userId" SET DATA TYPE TEXT;

-- AlterTable
ALTER TABLE "_ExpenseSplittingWindowToUser" ALTER COLUMN "B" SET DATA TYPE TEXT;

-- AlterTable
ALTER TABLE "_authorizedUsers" ALTER COLUMN "A" SET DATA TYPE TEXT,
